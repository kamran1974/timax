    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('technical', 'فنی'), ('services', 'خدمات'), ('other', 'سایر')], max_length=20, verbose_name='بخش فعالیت')),
                ...
                ('employment_type', models.CharField(choices=[('hourly', 'ساعتی'), ('contract', 'قراردادی')], max_length=20, verbose_name='نوع استخدام')),
